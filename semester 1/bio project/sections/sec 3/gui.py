...
#  GC content is essential for identifying species, understanding genome stability, and designing PCR primers
def gc_content(seq):
    try:
        seq = seq.upper()
...
class DNASequenceAnalyzer:
    def __init__(self, root):
        ...
        tk.Button(self.button_frame2, text="Reset History", command=self.reset_History, font=("Arial", 12), bg="#FF0000", fg="#FFFFFF", relief=tk.RAISED, borderwidth=2).pack(side=tk.LEFT, padx=20)
    ...
    def copy_result(self):
        ...
        messagebox.showinfo('coppied successfully',result)
